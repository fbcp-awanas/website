...
children = [
    {'last_name': 'Owen', 'allergies': '', 'photo_release': True, 'guest_of_id': None, 'group': 'C', 'dob': datetime.date(2010, 11, 28), 'special_instructions': '', 'first_name': 'Samantha', 'color': None, 'notes': '', 'gender': 'F', 'grade': 1, 'medical_release': True, 'family_id': owen_id, 'medications': '', 'guest': False}, 
    {'last_name': 'Owen', 'allergies': '', 'photo_release': True, 'guest_of_id': None, 'group': 'C', 'dob': datetime.date(2008, 3, 20), 'special_instructions': '', 'first_name': 'Dalton', 'color': None, 'notes': '', 'gender': 'M', 'grade': 4, 'medical_release': True, 'family_id': owen_id, 'medications': '', 'guest': False}, 
    {'last_name': 'Welch', 'allergies': '', 'photo_release': True, 'guest_of_id': 'Samantha Owen', 'group': 'C', 'dob': datetime.date(2012, 4, 7), 'special_instructions': '', 'first_name': 'Eleanor', 'color': None, 'notes': '', 'gender': 'F', 'grade': 0, 'medical_release': True, 'family_id': welch_id, 'medications': '', 'guest': True}, 
    {'last_name': 'Owen', 'allergies': '', 'photo_release': True, 'guest_of_id': None, 'group': 'S', 'dob': datetime.date(2006, 8, 19), 'special_instructions': '', 'first_name': 'Alysa', 'color': None, 'notes': '', 'gender': 'F', 'grade': 6, 'medical_release': True, 'family_id': owen_id, 'medications': '', 'guest': False}, 
    {'last_name': 'Owen', 'allergies': '', 'photo_release': True, 'guest_of_id': None, 'group': 'P', 'dob': datetime.date(2013, 3, 2), 'special_instructions': '', 'first_name': 'Liam', 'color': None, 'notes': '', 'gender': 'F', 'grade': -1, 'medical_release': True, 'family_id': owen_id, 'medications': '', 'guest': False}, 
    ]
